...
[참고(Link)](https://www.clien.net/service/board/cm_nas/14397343?po=0&sk=id&sv=pwrchan&groupCd=&pt=0) : vaapi 드라이버인 i965-va-driver(-shaders) 도 필요함. (apt install i965-va-driver(-shaders))
